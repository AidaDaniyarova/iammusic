...
function App() {
  ...
  className="fixed top-4 right-4 px-4 py-2 rounded-md font-semibold z-50
             bg-[var(--button-color-light)] dark:bg-[var(--button-color-dark)]
             text-white dark:text-white
             hover:bg-[var(--link-color-light)]
             transition"
>
